...
function createApplicant($first_name, $last_name, $email, $phone, $qualification, $specialization) {
    global $pdo;
    try {
...
function updateApplicant($id, $first_name, $last_name, $email, $phone, $qualification, $specialization) {
    global $pdo;
    try {
